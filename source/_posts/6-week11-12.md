...
<img src="/images/Algorithm-big-data/image-20230508210438333.png" alt="image-20230508210438333.png" style="zoom:50%;" />
...
![image-20230508210915962](/images/Algorithm-big-data/image-20230508210915962.png)
...
![image-20230508212327034](/images/Algorithm-big-data/image-20230508212327034.png)
...
<img src="/images/Algorithm-big-data/image-20230508214456671.png" alt="image-20230508214456671.png" style="zoom:50%;" />
...
<img src="/images/Algorithm-big-data/image-20230508215848361.png" alt="image-20230508215848361.png" style="zoom:50%;" />
...
<img src="/images/Algorithm-big-data/image-20230508215901237.png" alt="image-20230508215901237.png" style="zoom:50%;" />

- 假设 $r^*$为最优半径optimal radius.

- 声明：同一最佳集群中的两个站点彼此之间的距离最多为2r*

  <img src="/images/Algorithm-big-data/image-20230508220018534.png" alt="image-20230508220018534.png" style="zoom:50%;" />
...
1. **算法在最优集群中各挑了一个中心**
   ...
   <img src="/images/Algorithm-big-data/image-20230508220344170.png" alt="image-20230508220344170.png" style="zoom:50%;" />

   每个点到其最近的中心都 ≤ 2$r^*$

2. **一些最佳集群没有中心。**

   <img src="/images/Algorithm-big-data/image-20230508220507444.png" alt="image-20230508220507444.png" style="zoom:50%;" />
...
<img src="/images/Algorithm-big-data/image-20230508221345759.png" alt="image-20230508221345759.png" style="zoom:50%;" />

<h4 id="Analysis-bottleneck-algorithm">Analysis bottleneck algorithm</h4>

<img src="/images/Algorithm-big-data/image-20230508221721078.png" alt="image-20230508221721078.png" style="zoom:50%;" />
...
<img src="/images/Algorithm-big-data/image-20230508223639146.png" alt="image-20230508223639146.png" style="zoom:50%;" />
...
<img src="/images/Algorithm-big-data/image-20230508224146321.png" alt="image-20230508224146321.png" style="zoom:50%;" />
...
- 找出捷径 $\tau'$然后每个点只访问一次
  ...
  <img src="/images/Algorithm-big-data/image-20230508224311459.png" alt="image-20230508224311459.png" style="zoom:50%;" />
...
- 不需要double所有的边，只需将其转换为Eulerian graph（如果图中存在一个遍历所有边且每条边恰好被经过一次的路径，则该图是欧拉图）
  ...
  <img src="/images/Algorithm-big-data/image-20230508224739316.png" alt="image-20230508224739316.png" style="zoom:50%;" />
...
- 构建Euler tour $\tau$
  ...
  <img src="/images/Algorithm-big-data/image-20230508225457245.png" alt="image-20230508225457245.png" style="zoom:50%;" />

- 找出捷径 $\tau'$然后每个点只访问一次

  <img src="/images/Algorithm-big-data/image-20230508225532773.png" alt="image-20230508225532773.png" style="zoom:50%;" /> 

- length($\tau'$) ≤ length($\tau$) = cost(T) + cost(M) ≤ OPT + cost(M).

- cost(M) ≤ OPT/2.

  <img src="/images/Algorithm-big-data/image-20230508225715789.png" alt="image-20230508225715789.png" style="zoom:50%;" />
...
<img src="/images/Algorithm-big-data/image-20230508230444091.png" alt="image-20230508230444091.png" style="zoom:50%;" />
